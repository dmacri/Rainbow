  package it.icarcnr.business.charts.impl;
...
import it.icarcnr.integration.dao.generated.IServiceDAO;
import it.icarcnr.integration.dao.generated.Service;
import it.icarcnr.integration.dao.generated.ServiceDAO;
...
public class ServiceChartBL implements IServiceChartBL {
	...
	public List<CriteriaSensorValue> getChartDataBean(Integer sensorId, Date startDate, Date endDate) throws Exception {
		...
		try{
			ICriteriaHistoryAdvancedDAO iCriteriaHistoryAdvancedDAO = new CriteriaHistoryAdvancedDAO();
         	List<CriteriaSensorValue> criteriaSensorValueList = iCriteriaHistoryAdvancedDAO.getSensorValue(sensorId, startDate, endDate);
	      	
    		return criteriaSensorValueList;
		}catch (Exception e) {
			log.error(method,e);
			throw e;
		}
