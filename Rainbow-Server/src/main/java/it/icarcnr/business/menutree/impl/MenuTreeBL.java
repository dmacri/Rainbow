package it.icarcnr.business.menutree.impl;

import it.icarcnr.business.menutree.service.IMenuTreeBL;
import it.icarcnr.business.menutree.util.IClassNameUIConstants;
import it.icarcnr.business.menutree.util.IMenuTreeConstants;
import it.icarcnr.business.menutree.util.UserInterfaceUtil;
...
import it.icarcnr.integration.dao.generated.ILocationDAO;
import it.icarcnr.integration.dao.generated.Location;
import it.icarcnr.integration.dao.generated.LocationDAO;
...
import it.icarcnr.integration.dao.network.impl.NetworkAdvancedDAO;
...
import it.icarcnr.integration.dao.security.impl.AreaAdvancedDAO;
...
import it.icarcnr.integration.dao.util.INodeTypeConstants;
...
//				parameterMap.put("iconCls", areaIconCls);
				...
				if(!area.getId().equals(IAreaConstants.CHART_AREA) && !area.getId().equals(IAreaConstants.MAPS_GEOLOCATION)){
...
//			utilityGroupIdList.add( action.);
//			Set<Action> actionChildren = action.getActions();
//			for (Action actionChild : actionChildren) {
//				if(actionChild.getIdUtilityGroup()!=null){
//					utilityGroupIdList.add(actionChild.getIdUtilityGroup());
//				}
//			}
...
//		}
	...
	private void addNetworkTree(Date currentDate, Integer userId, Document doc, Element root, Area area, Network network, String parentURI) throws Exception {
		Map<String, Object> parameterMap = new HashMap<String, Object>();
		parameterMap.put(IParameterHttpServletRequestContants.NODE_SENSOR_ID, network.getId());
...
//		}
	...
	private void addFunctionTree(Document doc, Date currentDate, Element root, Area area, Network network, Function function, String parentURI) throws Exception {
		Map<String, Object> parameterMap = new HashMap<String, Object>();
		parameterMap.put(IParameterHttpServletRequestContants.NODE_SENSOR_ID, network.getId());
		parameterMap.put(IParameterHttpServletRequestContants.SENSOR_ID, function.getId());
