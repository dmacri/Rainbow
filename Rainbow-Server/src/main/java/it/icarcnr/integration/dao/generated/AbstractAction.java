...
public abstract class AbstractAction implements java.io.Serializable {
	...
	private Integer idUtilityGroup;
	...
	/** full constructor */
	public AbstractAction(Area area, Action action, String path,
			String description, Integer idUtilityGroup,
		...
		this.path = path;
		this.description = description;
		this.idUtilityGroup = idUtilityGroup;
	...
	@Column(name = "ID_UtilityGroup")
	public Integer getIdUtilityGroup() {
		return this.idUtilityGroup;
	}

	public void setIdUtilityGroup(Integer idUtilityGroup) {
		this.idUtilityGroup = idUtilityGroup;
	}
