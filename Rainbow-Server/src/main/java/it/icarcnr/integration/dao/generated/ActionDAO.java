 ...
 * datastore.
 * 
 * @see it.icarcnr.integration.dao.generated.Action
...
public class ActionDAO implements IActionDAO {
	...
	public static final String ID_UTILITY_GROUP = "idUtilityGroup";
	...
	public List<Action> findByIdUtilityGroup(Object idUtilityGroup) {
		return findByProperty(ID_UTILITY_GROUP, idUtilityGroup);
	}
