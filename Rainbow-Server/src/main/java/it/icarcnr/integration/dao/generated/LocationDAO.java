 ...
 * datastore.
 * 
 * @see it.icarcnr.integration.dao.generated.Location
...
public class LocationDAO implements ILocationDAO {
	...
	public void delete(Location entity) {
		...
		try {
			entity = getEntityManager().getReference(Location.class,
					entity.getId());
	...
	public Location findById(Integer id) {
		EntityManagerHelper.log("finding Location instance with id: " + id,
				Level.INFO, null);
		try {
	...
	public List<Location> findByProperty(String propertyName, final Object value) {
		EntityManagerHelper.log("finding Location instance with property: "
	...
	public List<Location> findAll() {
		EntityManagerHelper.log("finding all Location instances", Level.INFO,
				null);
		try {
