...
public class CheckJobStatusPermissionAction extends Action {
	private static final Log log = LogFactory.getLog(CheckJobStatusPermissionAction.class);
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			Boolean acknowledgementPermission = iSecurityBL.hasPermission(userLoginBean.getId(), IActionConstants.ACKNOLEDGMENT_ACTION_PATH, networkId, functionId);
			...
			record.put("acknowledgementPermission", acknowledgementPermission);	
