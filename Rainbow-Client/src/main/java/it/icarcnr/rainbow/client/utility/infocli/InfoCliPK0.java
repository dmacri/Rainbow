 ...
 *
 */
public class InfoCliPK0 extends BasePanel {
	...
	private Store getStore() {
		...
		connectionConfig.setTimeout(IUtilityConstants.TIME_WAIT_90_Sec);
		connectionConfig.setUrl(IActionPathConstants.INFOCLI_PK0_ACTION_PATH);
