...
//			setSize("100%", "100%");
	...
	private final static native void exportToJavaScript() /*-{
        jitWrappedObject = @it.icarcnr.rainbow.client.util.jit.JitWidget::getWrappedObject(Ljava/lang/String;);
        jitWrapperForwardEvent = @it.icarcnr.rainbow.client.util.jit.JitWidget::forwardEvent(Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;Lcom/google/gwt/core/client/JavaScriptObject;Lcom/google/gwt/core/client/JavaScriptObject;);
        jitWrapperForwardComputeEvent = @it.icarcnr.rainbow.client.util.jit.JitWidget::forwardEvent(Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;Lcom/google/gwt/core/client/JavaScriptObject;);
