...
public class GeoPrefixPK3Panel extends BasePanel{
	...
	private static final String GEO_PREFIX_PK3_NET = "PK3";
...
//		formPanelDistrict.setPaddings(15);
	...
	private UrlParam[] getParamsOutputFile() {
		...
		params[3] = new UrlParam("net",GEO_PREFIX_PK3_NET);
		return params;
	}
	...
	private UrlParam[] getDistrictParams() {
		UrlParam[] params = new UrlParam[4];
		params[0] = new UrlParam("net",GEO_PREFIX_PK3_NET);
	...
	private Store getStoreDistrict() {
		HttpProxy dataProxyLoad = new HttpProxy(IActionPathConstants.GEOAREAPK3DISTRICT_ACTION_PATH); 
