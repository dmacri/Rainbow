...
public class SensorComboBox extends ComboBox {
	...
	public SensorComboBox(String action,String valueFromMaps) {
		super();
		this.action=action;
	...
	public SensorComboBox(String action, UrlParam[] baseParams,String valueFromMaps) {
		super();
		this.action=action;
	...
	public SensorComboBox(String action, UrlParam[] baseParams, LoadOption loadOption,String valueFromMaps) {
		super();
		this.action=action;
		this.baseParams = baseParams;
		if(loadOption!=null){
	...
	public SensorComboBox(String action, UrlParam[] baseParams, LoadOption loadOption, Boolean startLoad,String valueFromMaps) {
		super();
		this.action=action;
		if(startLoad!=null){
	...
	private void initComboBox(String valueFromMaps) {
	    	...
	    	setMinChars(3);  
	    	setFieldLabel(iComboBox.FunctionComboBox_Function()); //$NON-NLS-1$
//		setLabelStyle("font-size:12px");
	     	setDisplayField("description");  //$NON-NLS-1$
	    	setMode(ComboBox.LOCAL);  
		    setTriggerAction(ComboBox.ALL);  
		    setEmptyText(iComboBox.FunctionComboBox_Enter_Function());   //$NON-NLS-1$
	       	setLoadingText(iComboBox.FunctionComboBox_Searching());   //$NON-NLS-1$
	    	setTypeAhead(true);  
